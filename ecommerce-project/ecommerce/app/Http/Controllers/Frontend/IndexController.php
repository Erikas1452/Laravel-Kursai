...
class IndexController extends Controller
{
    public function index(){
		...
		// $hot_deals = Product::where('hot_deals',1)->orderBy('id','DESC')->limit(3)->get(); Hot deals from database
		//Hot deals only with discount
	...
	public function TagWiseProduct($tag){
		// $products = Product::where('status',1)->where('product_tags_en',$tag)->where('product_tags_hin',$tag)->orderBy('id','DESC')->get(); Simple
		$products = Product::where('status',1)->where('product_tags_en',$tag)->where('product_tags_hin',$tag)->orderBy('id','DESC')->paginate(3); //Paginated
		$categories = Category::orderBy('category_name_en','ASC')->get();
