...
class ProductController extends Controller
{
    ...
    public function ProductDetails($id)
    {
		...
		$subsubcategory = SubSubCategory::where('id',$product->subsubcategory_id)->get();
		
		return view('backend.product.product_details',compact('category','brand','subcategory','subsubcategory','product','multiImgs'));
    }
}
